            ...
            <tbody className='text-sm font-normal'>
              {
                ...
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>Zellit Mootez</span></td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>deco-home</span></td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>pending</span></td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>elwolf@gmail.com</span></td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>ariana</span></td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><span>Tunis</span></td>
                <td scope='row' className='py-1 px-4 font-medium whitespace-nowrap'><div className='flex justify-start items-center gap-4'>
                <Link to='/admin/dashboard/archi/details/1' className='p-[6px] bg-green-500 rounded hover:shadow-lg hover:shadow-green-500/50'><FaEye/></Link>
