                    ...
                    <div className='w-[#32%]'>
                        <div className='pr-3 text-[#d0d2d6] text-lg'>
                            <div className='flex flex-col gap-1'>
                                <h2 className='pb-2 font-semibold'>Deliver to : Zellit Mootez</h2>
                                <p><span className='text-sm'>tunis, ariana soukra dar fadhal rue madina zarka N°24 </span></p>                                
                            </div>
                            <div className='flex justify-start items-center gap-3'>
                                <h2>Payment Status : </h2>
                                <span className='text-base'>paid</span>                                
                            </div>
                            <span>Price : $5454</span>
