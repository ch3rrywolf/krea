            ...
            <tbody className='text-sm font-normal'>
              {
                ...
                <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'><img className='w-[45px] h-[45px] rounded-sm' src={`http://localhost:3000/images/category/${d}.jpg`} alt="" /></td>
                <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'><span>Zellit Mootez</span></td>
                <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'><span>elwolf@gmail.com</span></td>
                ...
                <td scope='row' className='py-1 px-4 font-normal whitespace-nowrap'><div className='flex justify-start items-center gap-4'>
