...
import { archi_login, messageClear } from '../../store/Reducers/authReducer'
                ...
                <h2 className='text-xl mb-3'>Welcome to krea-design.tn </h2>
                    ...
                    <form onSubmit={submit}>
                      <div className='flex flex-col w-full gap-1 mb-3'>
                        ...
                        border-slate-700 bg-transparent rounded-md text-[#d0d2d6]
                        focus:border-indigo-500 overflow-hidden' type="text"
                      ...
                      <button disabled={loader ? true : false} className="bg-blue-500 w-full hover:shadow-blue-500/20
                      hover:shadow-lg text-white rounded-md px-7 py-2 mb-3">
                     {
                      ...
                      <div className="flex justify-center items-center gap-3">
                        <div className="w-[35px] h-[35px] flex rounded-md bg-orange-700
                        ...
                        <div className="w-[35px] h-[35px] flex rounded-md bg-indigo-700
