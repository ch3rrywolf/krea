                ...
                <form onSubmit={add}>
                    <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]'>
                        <div className='flex flex-col w-full gap-1'>
                            ...
                            <input className='px-4 py-1 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={state.name} type="text" placeholder='product name' name='name' id="name" />
                        </div>

                        <div className='flex flex-col w-full gap-1'>
                            <label htmlFor='brand'>Product name</label>
                            <input className='px-4 py-1 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={state.brand} type="text" placeholder='brand' name='brand' id="brand" />
                        </div>
                    ...
                    <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]'>
                        <div className='flex flex-col w-full gap-1 relative'>
                            ...
                            <input readOnly onClick={() => setCateShow(!cateShow)} className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={category} type="text" placeholder='--select category--' name='category' id="category" />
                        ...
                        <div className='flex flex-col w-full gap-1'>
                            ...
                            <input className='px-4 py-1 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={state.stock} type="number" min='0' placeholder='stock' name='stock' id="stock" />
                        </div>
                    ...
                    <div className='flex flex-col mb-3 md:flex-row gap-4 w-full text-[#d0d2d6]'>
                        ...
                        <div className='flex flex-col w-full gap-1'>
                            ...
                            <input className='px-4 py-1 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={state.discount} type="number" placeholder='discount%' name='discount' id="discount" />
                        </div>

                    </div>
                    <div className='flex flex-col w-full gap-1 text-[#d0d2d6] mb-5'>
                            <label htmlFor='description'>Description</label>
                            <textarea row={4} className='px-4 py-1 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' onChange={inputHandle} value={state.description} placeholder='description' name='description' id="description" />
                    </div>
                    <div className='grid lg:gris-cols-4 grid-cols-1 md:grid-cols-3 sm:gris-cols-2 sm:gap-4 md:gap-4 xs:gap-4 gap-3 w-full text-[#d0d2d6] mb-4'>
                        ...
                        <div className='flex'>
                        <button className='bg-blue-500 w-full hover:shadow-blue-500/50 hover:shadow-lg text-white rounded-md px-7 py-2 my-2'>Add Product</button>
                        </div>
                </form>
            </div>
        </div>
