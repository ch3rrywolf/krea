...
<div className='flex justify-center items-center py-3'>
                            {
                                image?.image ? <label htmlFor="img" className='h-[210px] w-[300px] relative p-3 cursor-pointer overflow-hidden'>
                        ...
                        <div className='px-0 md:px-5 py-2'>
                            <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative'>
                                ...
                                <div className='flex gap-2'>
                                    ...
                                    <p>
                                        <span className='bg-red-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded '>{userInfo.payment}</span> : <span className='bg-blue-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded '>
                                                click active
                                            </span>
                        ...
                        <div className='px-0 md:px-5 py-2'>
                            {
                                !userInfo?.shopInfo ? <form action=''>
                                    ...
                                    <div className='flex flex-col w-full gap-1 mb-3'>
                                        ...
                                        <input required  className='px-4 py-2 focus:border-indigo-500 outline-none bg-[#283046] border border-slate-700 rounded-md text-[#d0d2d6]' type="text" placeholder='sub district' name='sub_district' id='sub' />
                                    </div>
