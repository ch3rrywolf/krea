...
const Profile = () => {
    ...
    const add_image = (e) => {
        if (e.target.files.length > 0) {
            ...
            dispatch(profile_image_upload(file)); 
        }
    };
    useEffect(() => {
        if (successMessage) {
                    ...
                    <div className='px-0 md:px-5 py-2'>
                        <div className='flex justify-between text-sm flex-col gap-2 p-4 bg-slate-800 rounded-md relative'>
                            ...
                            <div className='flex gap-2'>
                                ...
                                <p>
                                    {
                                        userInfo.payment === 'active' ? <span className='bg-red-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded '>{userInfo.payment}</span> : <span onClick={() => dispatch()} className='bg-blue-500 text-white text-xs cursor-pointer font-normal ml-2 px-2 py-0.5 rounded '>
                                            click active
                                        </span>
                                    }
                                </p>
